...
# ``benedek_mlops_demo_0822/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-benedek_mlops_demo_0822-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops_demo.benedek_mlops_demo_0822-model", label="Full (Three-Level) Model Name"
)
