...
git add README.md docs .gitignore benedek_mlops_demo_0822/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://dbc-1707b521-4968.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-1707b521-4968.cloud.databricks.com#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[benedek_mlops_demo_0822/databricks.yml](../benedek_mlops_demo_0822/databricks.yml) file.
...
Follow the instructions in [benedek_mlops_demo_0822/resources/README.md](../benedek_mlops_demo_0822/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../benedek_mlops_demo_0822/resources/README.md)  to propose, test, and deploy
